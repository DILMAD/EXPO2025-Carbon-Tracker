...
arguments
    region (1,1) string {mustBeNonempty}
    commuteMode (1,1) string {mustBeMember(commuteMode, {'Car_Gasoline', 'Car_Diesel', 'Car_Electric_BEV', 'Bus', 'Train_Rail', 'Motorcycle', 'Cycling', 'Walking'})}
    dailyCommuteKm (1,1) double {mustBeNonnegative}
    commuteDaysPerYear (1,1) double {mustBeNonnegative}
    domesticFlightsPerYear (1,1) double {mustBeNonnegative}
    avgDomesticFlightKm (1,1) double {mustBeNonnegative}
    internationalFlightsPerYear (1,1) double {mustBeNonnegative}
